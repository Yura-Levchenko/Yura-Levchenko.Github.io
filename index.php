...
$log_string="$user_ip|$user brouser|$current time|\r\n";
...
<table border="1" align="center"   background="images/bg-3.jpg" cellpadding="10" >
    ...
    <tr>
	  ...
	  <font size="4"><b><a href="#">Наші послуги</a>&nbsp;&nbsp; <a href="#">Про нас</a>&nbsp;&nbsp; <a href="#">Інформація</a>&nbsp; &nbsp;<a href="#">Галерея робіт</a></b></font></td>
    </tr>
    <tr>
...
<input type="reset" value="Очистити">
      ...
      <td width="70%" background="images/bg.jpg"><font size="5" color="navy"><h2>Зробити сайт з нами легко</h2></font>
